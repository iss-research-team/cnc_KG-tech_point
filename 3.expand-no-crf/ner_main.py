...
def train():
    ...
    tok_list, seg_list, mask_list, tag_list, lens_list = make_data(data_list_train[:2000], tag_dict, max_len)
    loader_train = Data.DataLoader(MyDataSet(tok_list, seg_list, mask_list, tag_list, lens_list), batch_size, True)
    tok_list, seg_list, mask_list, tag_list, lens_list = make_data(data_list_test[:500], tag_dict, max_len)
